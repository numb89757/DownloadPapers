...
path = "/Users/yangyuzi/Library/CloudStorage/OneDrive-zju.edu.cn/论文/综述/"   #下载后的PDF存放的文件夹
if os.path.exists(path) == False:
	os.mkdir(path)  #20210607更新，创建保存下载文章的文件夹
f = open("/Users/yangyuzi/Desktop/doi.txt", "r", encoding="utf-8")  #存放DOI码的.txt文件中，每行存放一个文献的DOI码，完毕须换行（最后一个也须换行！）
head = {\
